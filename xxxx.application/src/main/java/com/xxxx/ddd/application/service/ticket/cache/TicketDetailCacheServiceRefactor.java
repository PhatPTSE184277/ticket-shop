...
public class    TicketDetailCacheServiceRefactor {
    ...
    // use guava
    private final static Cache<Long, TicketDetailCache> ticketDetailLocalCache = CacheBuilder.
            newBuilder()
            .initialCapacity(10)
            .concurrencyLevel(12)
    ...
    public TicketDetailCache getTicketDetail(Long ticketId, Long version){
        ...
        if(ticketDetailCache != null){
            ...
            if (version > ticketDetailCache.getVersion()){
                return getTicketDetailDistributeCache(ticketId);
            }
        }
        return getTicketDetailDistributeCache(ticketId);
    }
    ...
    public TicketDetailCache getTicketDetailDatabase(Long ticketId) {
        ...
        try {
            ...
            ticketDetailCache = new TicketDetailCache().witchClone(ticketDetail).withVersion(System.currentTimeMillis());
     ...
     */
    public TicketDetailCache getTicketDetailDistributeCache(Long ticketId){
        // 1 - get data
        TicketDetailCache ticketDetailCache = redisInfrasService.getObject(genEventItemKey(ticketId), TicketDetailCache.class);
        if (ticketDetailCache == null){
    ...
    public String genEventItemKey(Long ticketId){
        return "PRO_TICKET:ITEM:" + ticketId;
    }

    public String genEventItemKeyLock(Long ticketId){
